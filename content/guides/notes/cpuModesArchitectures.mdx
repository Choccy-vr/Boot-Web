...
Before to pass to the code explanation, you need to know the concept of *GDT* (Global Descriptor Table). I recommand reading the [Global Descriptor Table guide](/guides/notes/globalDescriptionTable) before continue.
