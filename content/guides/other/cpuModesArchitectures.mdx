...
<Callout title="Disclaimer">This guide is meant for people with very little experience. If you follow along and have a curious mind, this will teach you extremely important concepts in osdev.</Callout>
...
The bit 7 of the *Page Directory Table* must be 1, otherwise the CPU will think that's a *Page Directory Pointer Table*.
