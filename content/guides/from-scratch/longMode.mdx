...
<Callout title="Guide Reference">This guide contain a part of the informations located in the [CPU System Management Modes guide](/guides/other/cpuModesArchitectures).</Callout>
